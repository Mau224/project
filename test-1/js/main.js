...
//
// растяжение популярных категорий за границу окна
// var bestItemWidth = 307;
// if(wWidth <=867){
//   bestItemMobWidth = 237
// };
// var bestItem = $('.home-best__item');
// $('.home-best__list').css('width', $('.home-best__title-block h2').innerWidth()*1.3 *bestItem.length);
// console.log(bestItemWidth *bestItem.length);
// $(window).on('resize', function(){
//   $('.home-best__list').css('width', $('.home-best__title-block h2').innerWidth()*1.3 *bestItem.length);
// })
// if(wWidth <=867){
//   $('.home-best__list').css('width', bestItemMobWidth * bestItem.length);
//   console.log(bestItemWidth *bestItem.length);
//   $(window).on('resize', function(){
//     $('.home-best__list').css('width', bestItemMobWidth * bestItem.length);
//   })
...
// cлайдер популярных категорий

if (window.innerWidth > 870) {
  jQuery(".home-best__list").slick({
    slidesToShow: 2.5,
    slidesToScroll: 1,
    centerMode: false,
    initialSlide:0,
    ...
    variableWidth: true,
    // centerPadding: '10vw',
    prevArrow: jQuery('.home-best-left'),
    nextArrow: jQuery('.home-best-right'),
  });
}

// горизонтальный скролл популярных категорий

// var bestListWidth = $('.home-best__list').outerWidth();

var wWidth = $(window).width();
gsap.registerPlugin(ScrollTrigger);

// var bestListWidthVal = -bestListWidth + wWidth/1.33;
//
// if (wWidth <= 867) {
//     bestListWidthVal = -bestListWidth
// };
...
//     bestListWidthVal = -bestListWidth
//   } else {
//     bestListWidthVal = -bestListWidth + wWidth/1.33;
//   }
// });

// var popularHeight = $('.home-best').innerHeight();
...
// // горизонтальный скролл спецпредложений
//
// var specialListWidth = $('.home-special__list').outerWidth();
// console.log(specialListWidth * $('.home-special__item').length);
//
// var specialListVal = -specialListWidth*1.7;
//
// if (wWidth <= 567) {
//   specialListVal = -specialListWidth * ($('.home-special__item').length / 6.5)
// };
//
// $(window).on('resize', function(){
// if (wWidth <= 567) {
//   specialListVal = -specialListWidth * ($('.home-special__item').length / 7)
// } else {
//   specialListVal = -specialListWidth*1.7;
// }
// });
//
// if(wWidth >= 867){
...
// смена изображений в hero

var slides = document.querySelectorAll('.home-block__img-item');
var currentSlide = 0;
...
// появление оранжевых регионов на карте РФ
  ...
  var regArray = [];
  var logoArray = [];
  jQuery('.svg-item').each(function(){
    regArray.push(this);
  });
  jQuery('.map-logo').each(function(){
    logoArray.push(this);
  });
  ...
  ScrollTrigger.create({
    ...
    onEnter: function regionShow(){
      for(var r = 0; r<=regArray.length-1; r++){
        var arrayData = regQueryArray[r];
        gsap.to(regArray[arrayData], {delay: regDelay, fill: '#FCD5B3'});
        gsap.to(logoArray[arrayData], {delay: regDelay, opacity: '1'});
        regDelay += 0.2
      }
    }
  });
...
// показ модалок при наведении

  // 1. присваиваем каждому региону и каждой модалке атрибут regNumber с идентичными номерами
  var k = 1;
  var l = 1;
  $('.svg-item').each(function(){
    $(this).attr('regNumber', k);
    k++
  });

  $('.map-text-block').each(function(){
    $(this).attr('regNumber', l);
    l++
  });

  // 2. показываем при наведении
  ...
  $('.svg-item').each(function(){
    ...
    $(this).hover( function(){
        $('.map-text-block[regNumber = "'+regNumber+'"]').addClass('map-tip-visible');
    }, function(){
        $('.map-text-block[regNumber = "'+regNumber+'"]').removeClass('map-tip-visible');
    });

  });


  // позиционируем "хвостик" таблички с инфой
  $('.home-map__info').each(function(){
    var infoWidth = $(this).outerWidth();
    var infoSvgWidth = $(this).find('svg').outerWidth();
    $(this).find('svg').css('left', (infoWidth/2) - (infoSvgWidth/2))
  });
  $(window).on('resize', function(){
    $('.home-map__info').each(function(){
      var infoWidth = $(this).outerWidth();
...
// карта партнеров (карта мира)
  ...
  $('.russia-name').hover(
    function(){
      $('.partner-name, .sup-name').removeClass('displayed');
      $('.russia-parners, .russia-sup-name').addClass('displayed');

      $('.russia-name').css('color', '#F57401')
    },
    function(){

      $('.russia-name').css('color', '#000000')
    }
  )
  $('.europe-name').hover(
    function(){
      $('.partner-name, .sup-name').removeClass('displayed');
      $('.europe-parners, .europe-sup-name').addClass('displayed');
      $('.europe-name').css('color', '#F57401')
    },
    function(){

      $('.europe-name').css('color', '#000000')
    }
  )
  $('.india-name').hover(
    function(){
      $('.partner-name, .sup-name').removeClass('displayed');
      $('.india-parners, .india-sup-name').addClass('displayed');
      $('.india-name').css('color', '#F57401')
    },
    function(){

      $('.india-name').css('color', '#000000')
    }
  )
  $('.thaiwan-name').hover(
    function(){
      $('.partner-name, .sup-name').removeClass('displayed');
      $('.thaiwan-parners, .thaiwan-sup-name').addClass('displayed');
      $('.thaiwan-name').css('color', '#F57401')
    },
    function(){

      $('.thaiwan-name').css('color', '#000000')
    }
  )
  $('.china-name').hover(
    function(){
      $('.partner-name, .sup-name').removeClass('displayed');
      $('.china-parners, .china-sup-name').addClass('displayed');
      $('.china-name').css('color', '#F57401')
    },
    function(){

      $('.china-name').css('color', '#000000')
    }
  )
  $('.africa-name').hover(
    function(){
      $('.partner-name, .sup-name').removeClass('displayed');
      $('.africa-parners, .africa-sup-name').addClass('displayed');
      $('.africa-name').css('color', '#F57401')
    },
    function(){

      $('.africa-name').css('color', '#000000')
    }
  )
  $('.korea-name').hover(
    function(){
      $('.partner-name, .sup-name').removeClass('displayed');
      $('.korea-parners, .korea-sup-name').addClass('displayed');
      $('.korea-name').css('color', '#F57401')
    },
    function(){
...
// слайдер cпецпредложение

if (wWidth >= 870) {
  jQuery(".home-special__list").slick({
    slidesToShow: 2.5,
    slidesToScroll: 1,
    centerMode: false,
    initialSlide:0,
    ...
    variableWidth: true,
    // centerPadding: '10vw',
    prevArrow: jQuery('.home-special-left'),
    nextArrow: jQuery('.home-special-right'),
  });
}
...
let select = function () {
    ...
    let modalClose = document.querySelectorAll('.close_reg-modal');
...
const modalCloseModlCity = document.querySelector('.modal-close-btn');
...
if (window.innerWidth < 870) {
    modalOpen.addEventListener('click', function() {
        ...
        overlayCity.style.top = '114px';
    })

    modalCloseModlCity.addEventListener('click',function (){
        overlayCity.style.top = '0';
        body.classList.remove('dis');
    })
}
...
function openNav() {
    ...
    menuBtn.addEventListener('click', function () {
        ...
        headerCont.classList.remove('index-max');
        overlayCity.classList.remove('active');
        overlayCity.classList.remove('index-max');
    })
...
let closeModalProductlist = document.querySelector('.modal-product__close');
closeModalProductlist.addEventListener('click', function (){
    body.classList.remove('dis');
})
...
let cartClose = document.querySelector('.modal-cart__close');
...
cartClose.addEventListener('click', function (){
    if(window.innerWidth < 870){
        let hedPhnLnk2 = document.querySelector('.modal-open__phones');
        hedPhnLnk2.classList.remove('active');
        modalEmailBody.classList.remove('active');
        modalPhonesLink.innerHTML = '8 (555) 555-55-55' + '<svg class="svg-sprite-icon icon-phone">\n' +
...
let overlaylogMob = document.querySelector('.overlay-modal');
...
openLogin.addEventListener('click', function (){
    ...
    if(window.innerWidth < 870) {
        let hedPhnLnk2 = document.querySelector('.modal-open__phones');
        hedPhnLnk2.classList.remove('active');
        overlaylogMob.classList.add('active');
        overlaylogMob.classList.add('index-max');
        document.querySelector('.header__container').classList.add('index-max');
        modalEmailBody.classList.remove('active');
        modalPhonesLink.innerHTML = '8 (555) 555-55-55' + '<svg class="svg-sprite-icon icon-phone">\n' +
          '                <use xlink:href="images/sprite/symbol/sprite.svg#phone"></use>\n' +
          '              </svg>';
...
closeLogin.addEventListener('click', function () {
    loginBlock.style.display = "none";
    overlay.classList.remove('active');
    overlay.classList.remove('index-max');
})
...
modalEmail.addEventListener('click', function (){
    ...
    if(window.innerWidth > 870){
        ...
        if(modalEmail.classList.contains('active')) {
            modalEmail.textContent = 'email@email.ru';
        } else {
            modalEmail.textContent = 'Список адресов:';
        }
    }
    ...
    if(window.innerWidth < 870) {
        ...
        overlayModal.classList.add('index-max');
        overlay.classList.add('index-max');
...
modalCloseEmail.addEventListener('click', function (){
    ...
    overlayModal.classList.remove('index-max');
    modalEmail.classList.remove('active');
})
...
let BtnClose = document.querySelector('.modal-search__close');
...
searchOpen.addEventListener('click', function (){
    ...
    if(window.innerWidth < 870) {
        let hedPhnLnk = document.querySelector('.header__phone-link');
        hedPhnLnk.classList.remove('active');
        loginBlock.style.display = "none";
        modalEmailBody.classList.remove('active');
        modalPhonesLink.innerHTML = '8 (555) 555-55-55' + '<svg class="svg-sprite-icon icon-phone">\n' +
          '                <use xlink:href="images/sprite/symbol/sprite.svg#phone"></use>\n' +
...
modalPhone.forEach(function(item){
    item.addEventListener('click', function (){
        ...
        if (window.innerWidth < 867) {
            overlayModal.classList.toggle('active');
            overlayModal.classList.add('index-max');
            overlayModal.classList.remove('lowindex');
        ...
        // let phoneBtn = document.querySelector('.header__phone-link');
        ...
        if(item.classList.contains('active')) {
            ...
            // overlayModal.classList.add('123');
...
// im.mask(selector);
//
// let selector2 = document.querySelectorAll('input[type="tel"]');
//
